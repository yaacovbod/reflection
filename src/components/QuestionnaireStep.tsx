...
const QUESTIONS: { key: keyof Answers; label: string; hint: string }[] = [
  {
    key: 'study',
    label: 'השקעה לימודית',
    hint: 'באיזה מקצוע או פרויקט השקעת הכי הרבה מאמץ השנה, ומהו ההישג שאת/ה הכי גאה/גאה בו?',
  },
  {
    key: 'social',
    label: 'מעורבות חברתית',
    hint: 'איך תתאר/י את התרומה שלך לאווירה בכיתה ואת היחסים שלך עם החברים/ות והמורים/ות?',
  },
  {
    key: 'conduct',
  ...
  },
  {
    key: 'goal',
    label: 'יעד להמשך',
    hint: 'מהו היעד המעשי המרכזי שאת/ה מציב/ה לעצמך לשנה הבאה כדי להתקדם?',
  },
]
